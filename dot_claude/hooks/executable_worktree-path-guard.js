...
//
// Problem: subagents spawned with isolation="worktree" sometimes issue Edit/Write
// calls with absolute paths rooted at the MAIN repository instead of the active
// worktree. Prose guards are unreliable — the model under load skips them.
//
